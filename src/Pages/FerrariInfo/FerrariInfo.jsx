    ...
    return (
        ...
        <div>
            ...
            <div className="m-24 min-h-screen">
                ...
                {
                    cars.length > 0 ? <div className="grid grid-cols-3 gap-4">
                        {
                            cars?.map(car => <CarCard key={car._id} car={car}></CarCard>)
                        }
                    </div> : <h1 className="text-5xl font-bold h-[80vh] flex items-center justify-center">No products available</h1>
                }
